...
interface ISample1155 is IERC1155MetadataURI {
    function mintByAdmin(address to, uint256 tokenId, uint256 value) external;
    function burn(uint256 tokenId, uint256 value) external;

    event MintByAdmin(address indexed to, uint256 indexed tokenId, uint256 value, uint256 balance);
